...
const Sidebar = () => {
    ...
    <button onClick={toggleSidebar} className="fixed top-4 left-4 z-50 text-white md:hidden">
        <AiOutlineClose size={30} />
            ...
            <div className={`fixed flex flex-col justify-between top-0 left-0 h-full bg-gray-900 text-white shadow-lg transition-transform duration-500 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 md:relative md:w-auto`} 
